...
class PostController extends Controller
{
    ...
    public function danh_muc_bai_viet(Request $request,$post_slug){
        ...
        $post_cate = Post::with('cate_post')->where('post_status',1)->where('cate_post_id',$cate_id)->paginate(5);
       
        return view('pages.baiviet.danhmucbaiviet')->with('category',$category)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('post_cate',$post_cate)->with('category_post',$category_post)->with('share_image',$share_image);
    }
    public function bai_viet(Request $request,$post_slug){
        ...
        return view('pages.baiviet.baiviet')->with('category',$category)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('post_by_id',$post_by_id)->with('category_post',$category_post)->with('related',$related)->with('share_image',$share_image);
    }
