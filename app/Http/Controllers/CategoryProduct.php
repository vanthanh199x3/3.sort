...
class CategoryProduct extends Controller
{
    ...
    public function add_category_product(){
        ...
        return view('admin.category.add_category_product')->with('category',$category);
    }
    ...
    public function show_category_home(Request $request ,$slug_category_product){
        ...
        return view('pages.category.show_category')->with('category',$category)->with('category_by_id',$category_by_id)->with('category_name',$category_name)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical);
    }
