...
@section('admin_content')
  ...
  <div class="panel panel-default">
    ...
    <div class="row w3-res-tb">
      <div class="col-sm-4">
               <a href="{{URL::to('/add-slider')}}" class="btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Thêm slider </a>
      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td>
               <a href="{{URL::to('/edit_slider/'.$slide->slider_id)}}" class="active styling-edit" ui-toggle-class="">
