                        ...
                        <div class="panel-body">
                            ...
                            @foreach($contact as $key => $cont)
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" data-validation="length" data-validation-length="min5" data-validation-error-msg="Làm ơn điền ít nhất 5 ký tự"  rows="8" class="form-control" name="info_contact" id="my-editor" >{{$cont->info_contact}}</textarea>
                                </div>
                                <div class="form-group">
                                    <label for="exampleInputPassword1">Bản đồ</label>
                                    <textarea style="resize: none" data-validation="length" data-validation-length="min5" data-validation-error-msg="Làm ơn điền ít nhất 5 ký tự"  rows="8" class="form-control" name="info_map" id="my-editor2">{{$cont->info_map}}</textarea>
                                </div>
                              <!--   <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <img src="{{url('/public/uploads/logo/'.$cont->info_logo)}}" height="100" width="200">
                                </div>
